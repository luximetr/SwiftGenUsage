...
internal enum PlistFiles {
  internal enum BaseURL {
    private static let _document = PlistDocument(path: "BaseURL.plist")
    internal static let baseURL: String = _document["baseURL"]
  }
  internal enum CurrentUser {
    private static let _document = PlistDocument(path: "CurrentUser.plist")
    internal static let name: String = _document["Name"]
    internal static let surname: String = _document["Surname"]
  }
  internal enum Info {
